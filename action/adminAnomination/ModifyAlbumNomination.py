...
from DB_utils import update_album_nomination, album_nomination_exist
from utils import list_option, get_selection

class ModifyAlbumNomination(Action):
    ...
    def exec(self, conn):
        """
        Modify an album nomination in the database.
        """
        ...
        try:
            update_album_nomination(nomination_id, select_item, new_value)
