...
class ModifyUserInfo(Action):
    ...
    def __init__(self, action_name):
        ...
        self.info_option = ["Username", "Password", "Gender", "Bdate"]
    ...
    def exec(self, conn, user):
        ...
        if item == "Gender":
            new_value = self.read_input(conn, f'new value for {item} (you should enter [Male, Female, Other])')
        elif item == "Bdate":
            new_value = self.read_input(conn, f'new value for {item} (in YYYY-MM-DD format)')
        else:
